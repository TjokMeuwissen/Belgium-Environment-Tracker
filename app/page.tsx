...
const SECTIONS = [
  {
    ...
    emoji: '📊',
    title: 'Indicators',
    desc:  'Track Belgium\'s progress on environmental objectives across 6 topics — from greenhouse gas emissions to biodiversity loss.',
    cta:   'View indicators →',
    color: '#f97316',
    soon:  false,
  },
  {
    href:  '/indicators/regional',
    emoji: '🗺️',
    title: 'Regional data',
    desc:  'Compare how Flanders, Wallonia and Brussels perform on key environmental indicators.',
    cta:   'View regional data →',
    color: '#3b82f6',
    soon:  true,
  },
  {
