...
export default function AirQualityDetailPage() {
  ...
  if (!indicatorName) return (
    <div style={{ padding: 48, textAlign: 'center' }}>
      ...
      <Link href="/?topic=air_quality" style={{ color: TOPIC_COLOR, fontWeight: 600 }}>← Back to overview</Link>
    </div>
  );
    ...
    <div className="detail-page">
      <div className="detail-header" style={{ background: '#1a1a1a' }}>
        <div className="detail-header-inner">
          <Link href="/?topic=air_quality" className="back-link">← Back to overview</Link>
