  ...
  return (
    <div style={{display:'flex',gap:6,marginTop:10,alignItems:'center'}}>
      ...
      {([
        ...
        <button key={o.id} onClick={()=>onChange(o.id)}
          style={{padding:'5px 12px',borderRadius:7,border:`2px solid ${val===o.id?ACCENT:'#e5e7eb'}`,background:val===o.id?ACCENT_BG:'#fff',cursor:'pointer',fontSize:12,fontWeight:600,color:val===o.id?ACCENT:'#374151',lineHeight:1.4,textAlign:'center'}}>
          <div>{o.label}</div>
          <div style={{fontSize:10,color:val===o.id?ACCENT:'#9ca3af',fontWeight:400}}>{o.sub}</div>
        </button>
      ))}
    </div>
  );
