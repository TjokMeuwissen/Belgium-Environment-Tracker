  ...
  return (
    <div id="methodology" style={{background:'#fff',borderRadius:12,boxShadow:'0 1px 4px rgba(0,0,0,0.08)',padding:'28px 32px',marginBottom:20}}>
      ...
      {[
        ...
        {
          title:'⚡ Electricity',
          text:'Grid emission factor: 0.185 kg CO₂eq/kWh (EEA lifecycle methodology). This is higher than the direct combustion figure (Ember/Nowtricity: 0.110 kg/kWh) because it includes the nuclear fuel cycle, upstream gas methane leakage, grid transmission losses, and wind/solar infrastructure. All users use the same factor regardless of green contract type — unbundled Guarantees of Origin have negligible additionality (Brander et al. 2018; GHG Protocol Scope 2 Guidance). Solar panel calculation: total annual generation (kWp × 900 kWh/kWp/year, Belgium average) is subtracted from total electricity demand per person. If generation exceeds demand, the electricity footprint floors at 0 — no negative credit is given for surplus exported to the grid. This is a deliberate methodological choice: export credit could create a false impression of being "carbon negative" from a personal lifestyle perspective. Grid export does benefit the energy system, but this benefit is not attributed to the individual in this calculator. Solar panel lifecycle: 40 kg CO₂eq/kWp manufacturing, 25-year lifetime. Electricity default values: Fluvius/VREG reference consumption by household size, adjusted by home size using an engineering multiplier (studio ×0.85, small ×0.90, medium ×1.0, large ×1.15, very large ×1.30).',
        },
        {
          title:'🍽️ Food & Diet',
