    ...
    <div id="methodology" style={{background:'#fff',borderRadius:12,boxShadow:'0 1px 4px rgba(0,0,0,0.08)',padding:'28px 32px',marginBottom:20}}>
      ...
      {([
        ...
        },
        {
          title:'⚡ Electricity',
          items:[
            { label:'Grid emission factor: 0.185 kg CO₂eq/kWh (lifecycle, incl. nuclear fuel cycle, upstream gas leakage, grid losses)', url:'https://www.eea.europa.eu/en/analysis/maps-and-charts/co2-emission-intensity-15', source:'EEA — CO₂ emission intensity of electricity generation' },
