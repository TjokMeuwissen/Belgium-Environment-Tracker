...
const SECTION_DEFS: Record<string, { id: string; label: string }[]> = {
  'total-ghg-emissions': [
    ...
    { id: 'ghg-explainer',  label: 'What is a GHG?'      },
    { id: 'ghg-bubbles',    label: 'Gas breakdown'        },
  ...
  'per-capita-ghg-footprint': [
    ...
    { id: 'footprint-explainer', label: 'Carbon footprint?'   },
    { id: 'benchmarks',          label: 'Country comparison'  },
    { id: 'technical-info',      label: 'Technical info'      },
    { id: 'consequences',        label: 'Consequences'        },
    { id: 'responsibility',      label: 'Gov. responsibility' },
    { id: 'policy',              label: 'Policy'              },
  ...
  'final-energy-consumption': [
    ...
    { id: 'energy-sectors',   label: 'By sector'           },
    { id: 'energy-explainer', label: 'Electricity vs heat' },
    { id: 'technical-info',   label: 'Technical info'      },
    { id: 'consequences',     label: 'Consequences'        },
    { id: 'responsibility',   label: 'Gov. responsibility' },
    { id: 'policy',           label: 'Policy'              },
  ...
  'renewable-electricity-share-of-generation': [
    { id: 'key-figures',      label: 'Key figures'         },
    { id: 'main-chart',       label: 'Renewables mix'      },
    { id: 'capacity-targets', label: 'Future capacity'     },
    { id: 'grid-congestion',  label: 'Grid congestion'     },
    { id: 'technical-info',   label: 'Technical info'      },
    { id: 'consequences',     label: 'Consequences'        },
    { id: 'responsibility',   label: 'Gov. responsibility' },
    { id: 'policy',           label: 'Policy'              },
    ...
    <div className="detail-page">
      ...
      <div className="detail-body">
        ...
        <div className="detail-main">
          ...
          {/* total-ghg-emissions extras */}
          {slug === 'total-ghg-emissions' && (<>
            <div id="ghg-explainer" className="detail-charts"><WhatIsGHGCard /></div>
            <div id="ghg-bubbles"   className="detail-charts"><GHGBubbleChart /></div>
          </>)}

          {/* per-capita-ghg-footprint extras */}
          {slug === 'per-capita-ghg-footprint' && (<>
            <div id="footprint-explainer" className="detail-charts"><WhatIsFootprintCard /></div>
            <div id="benchmarks"          className="detail-charts"><PerCapitaComparisonChart /></div>
          </>)}

          {/* final-energy-consumption extras */}
          {slug === 'final-energy-consumption' && (<>
            {finalEnergyData.length > 0 && (
              <div id="energy-sectors" className="detail-charts"><EnergySectorsChart data={finalEnergyData} /></div>
            )}
            <div id="energy-explainer" className="detail-charts"><ElectricalVsThermalCard /></div>
          </>)}

          {/* renewable-electricity extras */}
          {slug === 'renewable-electricity-share-of-generation' && (<>
            {renewableCapData.length > 0 && (
              <div id="capacity-targets" className="detail-charts"><RenewableCapacityChart data={renewableCapData} /></div>
            )}
            <div id="grid-congestion" className="detail-charts"><GridCongestionCard capacityData={renewableCapData} /></div>
          </>)}
