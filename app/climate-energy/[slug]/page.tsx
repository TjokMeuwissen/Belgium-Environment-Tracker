  ...
  return (
    <div className="detail-technical-card">
      ...
      <div style={{ marginBottom: 22 }}>
        <p style={{ fontSize: '0.88rem', lineHeight: 1.75, color: '#374151', marginBottom: 10 }}>
          <strong>What is a carbon footprint?</strong> A carbon footprint is the total amount of
...
function FinalEnergyTechnicalCard({
  ...
  return (
    <div className="detail-technical-card">
      ...
      <div style={{ marginBottom: 22 }}>
        <p style={{ fontSize: '0.88rem', lineHeight: 1.75, color: '#374151', marginBottom: 10 }}>
          <strong>What does final energy consumption represent?</strong> Final energy consumption
        ...
        <div style={{ background: '#eff6ff', borderRadius: 8, padding: '12px 14px', borderLeft: '4px solid #3b82f6' }}>
    ...
    <div className="detail-technical-card">
      ...
      <div style={{ marginBottom: 22 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
          <div style={{ background: '#eff6ff', borderRadius: 8, padding: '14px 16px', borderLeft: '4px solid #0369a1' }}>
...
export default function ClimateDetailPage() {
  ...
  if (slug === 'total-ghg-emissions') {
    ...
    technicalNode = (
      <>
        <FinalEnergyTechnicalCard fecHistorical={fecHistorical} />
    ...
    technicalNode = (
      <>
        <RenewableTechnicalCard renewableCapacity={renewableCapacity} />
        <CO2IntensityTable />
      </>
    );
  }
