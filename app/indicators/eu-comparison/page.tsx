...
const TOPICS: Topic[] = [
  {
    ...
    indicators: [
      {
        key: 'total_ghg', label: 'Total GHG emissions', unit: 'Mt CO₂eq', year: 2023,
        higherIsBetter: false, eu27: 107.7,
        ...
        note: 'Total net emissions (UNFCCC), including LULUCF. In Mt CO₂-equivalent.',
        info: 'Total net greenhouse gas emissions in million tonnes of CO₂-equivalent, including land use, land-use change and forestry (LULUCF). Reflects a country’s absolute climate footprint regardless of population size.',
        data: [
          {code:'DE',name:'Germany',value:740.7},{code:'FR',name:'France',value:339.0},
          {code:'IT',name:'Italy',value:331.2},{code:'PL',name:'Poland',value:315.8},
          {code:'ES',name:'Spain',value:218.9},{code:'NL',name:'Netherlands',value:146.4},
          {code:'CZ',name:'Czech Rep.',value:98.9},{code:'BE',name:'Belgium',value:97.9},
          {code:'AT',name:'Austria',value:76.2},{code:'EL',name:'Greece',value:67.8},
          {code:'IE',name:'Ireland',value:58.8},{code:'RO',name:'Romania',value:57.4},
          {code:'FI',name:'Finland',value:53.1},{code:'PT',name:'Portugal',value:51.2},
          {code:'HU',name:'Hungary',value:48.5},{code:'DK',name:'Denmark',value:38.8},
          {code:'BG',name:'Bulgaria',value:36.8},{code:'SK',name:'Slovakia',value:28.3},
          {code:'HR',name:'Croatia',value:19.9},{code:'LV',name:'Latvia',value:14.6},
          {code:'SE',name:'Sweden',value:13.2},{code:'EE',name:'Estonia',value:13.0},
          {code:'LT',name:'Lithuania',value:12.6},{code:'SI',name:'Slovenia',value:10.5},
          {code:'CY',name:'Cyprus',value:8.2},{code:'LU',name:'Luxembourg',value:7.1},
          {code:'MT',name:'Malta',value:2.2},
        ],
      },
      {
        ...
        info: 'Net greenhouse gas emissions per person, in tonnes of CO₂-equivalent. Includes LULUCF (land use and forestry). Normalises for country size, making it the standard measure for comparing individual-level climate impact across countries.',
        data: [
      ...
      },
      {
        ...
        info: 'Share of renewable sources (wind, solar, hydro, biomass, geothermal) in total final energy consumption, covering electricity, heating/cooling and transport. The EU’s 2030 target is 42.5%. Belgium’s low position reflects its historically nuclear-and-gas-heavy energy mix and lack of large hydro.',
        data: [
    ...
    indicators: [
      {
        ...
        info: 'Percentage of total agricultural land (utilised agricultural area, UAA) under certified organic farming. Organic farms prohibit synthetic pesticides and restrict synthetic fertilisers, generally supporting higher biodiversity, soil health and water quality than conventional farming.',
        data: [
    ...
    indicators: [
      {
        ...
        info: 'Share of municipal solid waste (household and similar waste) that is recycled or composted, as a percentage of total waste generated. Excludes incineration with energy recovery. The EU Circular Economy Action Plan targets 65% recycling by 2035.',
        data: [
      ...
      },
      {
        ...
        info: 'Total municipal solid waste generated per person per year, in kilograms. Includes household waste and similar commercial and institutional waste. The EU average is around 517 kg/person.',
        data: [
      ...
      },
      {
        ...
        source: 'Eurostat (env_wasmun)', sourceUrl: 'https://ec.europa.eu/eurostat/databrowser/view/env_wasmun/default/table',
        info: 'Percentage of municipal solid waste disposed of in landfills. Landfilling is the least preferred option in the EU waste hierarchy — it wastes resources, produces methane (a potent greenhouse gas), and risks groundwater contamination. The EU Landfill Directive targets near-zero landfilling by 2035.',
        data: [
      ...
      },
      {
        ...
        info: 'Share of total material consumption that comes from recycled secondary materials, rather than virgin raw materials. A higher CMUR means more of the economy’s material needs are met by reuse and recycling rather than new extraction.',
        data: [
    ...
    indicators: [
      {
        ...
        info: 'Annual mean concentration of fine particulate matter (particles smaller than 2.5 micrometres) averaged across monitoring stations. PM2.5 penetrates deep into the lungs and bloodstream and is the leading environmental cause of premature death.',
        data: [
      ...
      },
      {
        ...
        info: 'Annual mean concentration of nitrogen dioxide, averaged across monitoring stations. NO₂ is a marker of combustion pollution (mainly road traffic and industry), causes respiratory inflammation, and contributes to secondary PM2.5 formation.',
        data: [
    ...
    indicators: [
      {
        ...
        info: 'Share of inland passenger travel (measured in passenger-kilometres) made by public transport — trains, buses, coaches and trolleybuses. A higher share indicates less car dependency. Excludes tram and metro due to data harmonisation gaps.',
        data: [
  ...
  return (
    <main>
      <style>{`
        ...
        .info-icon-wrap:hover svg circle { stroke: #6b7280; }
        .info-icon-wrap:hover svg circle:last-of-type, .info-icon-wrap:hover svg rect { fill: #6b7280; }
      `}</style>
      {/* Header */}
      <header>
              ...
              {indicator.info && (
                <span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center' }} className="info-icon-wrap">
                  ...
                  <span style={{
                    ...
                    borderRadius: 8, padding: '10px 14px', fontSize: '0.78rem', lineHeight: 1.55,
