...
function HomeInner() {
  ...
  const [activeView, setView]    = useState<'national' | 'regional'>('national');
    ...
    <main>
      ...
      <div className="view-toggle-bar">
        <div className="view-toggle">
          <button
            className={`view-toggle-btn${activeView === 'national' ? ' active' : ''}`}
            onClick={() => setView('national')}
          >
            🇧🇪 National
          </button>
          <button
            className={`view-toggle-btn${activeView === 'regional' ? ' active' : ''}`}
      ...
      {activeView === 'regional' ? (
        <div className="regional-shell">
          ...
          <p>
            This section will show how Flanders, Wallonia and Brussels each perform on key
            environmental indicators — where region-level data is officially available.
          </p>
        </div>
      ) : (
        <>
