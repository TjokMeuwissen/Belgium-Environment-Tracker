  ...
  return (
    <main>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e5e7eb', padding: '0 48px', display: 'flex', gap: 4, alignItems: 'center' }}>
        ...
        <Link href="/indicators/eu-comparison" style={{ padding: '12px 20px', fontSize: '0.88rem', fontWeight: 600, color: '#6b7280', textDecoration: 'none', borderBottom: '2px solid transparent', display: 'inline-block' }}>
          Belgium vs EU
        </Link>
      </div>
