  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ background: '#1a1a1a', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 48px 36px 256px' }}>
          ...
          <div style={{ display: 'flex', gap: 28, marginTop: 20, flexWrap: 'wrap', alignItems: 'center' }}>
            {[
              ...
              <span key={r.label} style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 10, fontSize: '0.85rem', color: '#d1d5db' }}>
      ...
      <div className="view-toggle-bar">
        <div className="view-toggle">
          ...
          <button className="view-toggle-btn active">Regional</button>
          <a href="/indicators/eu-comparison" className="view-toggle-btn" style={{ textDecoration: 'none' }}>
            Belgium vs EU
          </a>
        </div>
      </div>
