    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ background: '#1a1a1a', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 48px 36px' }}>
          <a href="/indicators" style={{ color: '#888', fontSize: '0.85rem', fontWeight: 600, textDecoration: 'none' }}>
            \u2190 Back to national indicators
          </a>
          <h1 style={{ fontFamily: 'Roboto, sans-serif', fontSize: 'clamp(1.6rem, 4vw, 2.4rem)', fontWeight: 900, marginTop: 12, letterSpacing: '-0.02em', lineHeight: 1.1 }}>
            Regional Indicators
          </h1>
          ...
          <div style={{ display: 'flex', gap: 20, marginTop: 16, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: '0.82rem', color: '#9ca3af' }}>
              <svg width="28" height="2" style={{ display: 'inline-block' }}>
                <line x1="0" y1="1" x2="28" y2="1" stroke="#9ca3af" strokeWidth="2" strokeDasharray="4 3" />
              </svg>
              National reference line (topic colour)
            </span>
          </div>
        </div>
      </div>
