...
function BelgianBiomassChart() {
  ...
  return (
    <div style={{ background: '#f9fafb', borderRadius: 10, padding: '20px', margin: '20px 0' }}>
      ...
      <p style={{ fontSize: 11, color: '#6b7280', margin: '0 0 16px' }}>Source: {r.source}</p>
...
function BiodiversityLevels() {
  ...
  return (
    <div style={{ margin: '20px 0' }}>
      ...
      {/* Click hint */}
      <p style={{ textAlign: 'center', fontSize: 12, color: '#6b7280', margin: '4px 0 16px' }}>
      ...
      {detail ? (
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            ...
            <button onClick={() => setSelected(null)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#6b7280', fontSize: 13, padding: '2px 6px' }} aria-label="Close">✕</button>
          </div>
          <p style={{ fontSize: 14, color: '#374151', lineHeight: 1.7, margin: 0 }}>{detail.body}</p>
        </div>
      ) : (
        <div style={{ background: '#f9fafb', borderRadius: 10, padding: '12px 16px', textAlign: 'center', fontSize: 13, color: '#6b7280' }}>
      ...
      >
        <div className="detail-header-inner" style={{ display: 'flex', alignItems: 'flex-start', gap: 32 }}>
          <div style={{ flex: 1 }}>
            ...
            >
              From genes to entire ecosystems &mdash; why the variety of life on Earth
              is the foundation of everything we depend on.
            </p>
          </div>
          <img
            src="/images/learn/biodiversity.jpg"
            alt="Biodiversity"
        ...
        <div className="detail-main">
          ...
          <SectionCard id="sources">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                {
                  label: 'Bar-On YM, Phillips R, Milo R (2018) \u2014 The biomass distribution on Earth. PNAS 115(25):6506\u20136511',
                  url: 'https://doi.org/10.1073/pnas.1711842115',
                },
                {
                  label: 'INBO \u2014 Biomassa grote zoogdieren in Vlaanderen (Natuurrapport 2020 background indicator)',
                ...
                {
                  label: 'Belgian Biodiversity Platform \u2014 Species diversity in Belgium (~60,000 species recorded)',
                  url: 'https://www.biodiversity.be',
                },
                {
                  label: 'INBO \u2014 Flemish Institute for Nature and Forest Research (vascular plants, breeding birds, Red List)',
                  url: 'https://www.inbo.be',
                },
                {
                  label: 'Natuurpunt / Aves \u2014 Belgian breeding bird atlas and monitoring',
                  url: 'https://www.natuurpunt.be',
                },
                {
                  label: 'SPW / D\u00e9partement de la Nature et des For\u00eats \u2014 \u00c9tat de l\u2019environnement wallon: biodiversit\u00e9',
                  url: 'https://etat.environnement.wallonie.be',
                },
                {
                  label: 'IPBES (2019) \u2014 Global Assessment Report on Biodiversity and Ecosystem Services (extinction rate 100\u20131,000\u00d7 background)',
                  url: 'https://ipbes.net/global-assessment',
                },
                {
                  label: 'Belgium Environment Tracker (2026) \u2014 Mammal biomass methodology for Wallonia and Brussels (full workbook)',
                  url: '/blog/mammal-biomass-wallonia',
                },
              ].map(link => (
                <a
                  key={link.url}
                  ...
                  style={{
                    ...
                    color: '#374151', fontSize: '0.88rem', fontWeight: 500,
                  }}
