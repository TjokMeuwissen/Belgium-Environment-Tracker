          ...
          <SectionCard id="red-list">
            ...
            <div style={{ borderLeft: '4px solid #0369a1', background: '#e0f2fe', borderRadius: '0 10px 10px 0', marginBottom: 12, overflow: 'hidden' }}>
              <div style={{ display: 'flex', gap: 0 }}>
                <div style={{ width: 120, flexShrink: 0, aspectRatio: '1/1' }}>
                  <img src="/images/learn/corn-bunting.jpg" alt="Corn bunting (Emberiza calandra)" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                </div>
            ...
            <div style={{ borderLeft: '4px solid #7c3aed', background: '#ede9fe', borderRadius: '0 10px 10px 0', marginBottom: 12, overflow: 'hidden' }}>
              <div style={{ display: 'flex', gap: 0 }}>
                <div style={{ width: 120, flexShrink: 0, aspectRatio: '1/1' }}>
                  <img src="/images/learn/hamster.jpg" alt="European hamster (Cricetus cricetus)" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                </div>
                <div style={{ padding: '16px 20px', flex: 1 }}>
            ...
            <div style={{ borderLeft: '4px solid #b45309', background: '#fef3c7', borderRadius: '0 10px 10px 0', marginBottom: 12, overflow: 'hidden' }}>
              <div style={{ display: 'flex', gap: 0 }}>
                <div style={{ width: 120, flexShrink: 0, aspectRatio: '1/1' }}>
                  <img src="/images/learn/marsh-fritilarry.jpg" alt="Marsh fritillary (Euphydryas aurinia)" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                </div>
                <div style={{ padding: '16px 20px', flex: 1 }}>
