    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={280}>
        <BarChart
          data={freightData}
          layout="vertical"
          margin={{ top: 4, right: 60, left: 148, bottom: 24 }}
        >
      ...
      <div className="detail-body">
        ...
        <div className="detail-main">
          ...
          <SectionCard id="intro">
            ...
            {/* Container ship image — half width, preserving 1000x667 ratio */}
          ...
          <SectionCard id="sources">
            ...
            {[
              {
                label: 'MIT Climate Portal \u2014 Freight Transportation (IEA 2018 data)',
                url: 'https://climate.mit.edu/explainers/freight-transportation',
              },
              {
                label: 'EEA (2021) \u2014 Rail and waterborne: best for low-carbon motorised transport (Fraunhofer ISI / CE Delft)',
                url: 'https://www.eea.europa.eu/en/analysis/publications/rail-and-waterborne-best-for-low-carbon-motorised-transport',
              },
              {
                label: 'ECTA \u2014 Guidelines for Measuring and Managing CO\u2082 Emissions from Freight Transport Operations',
                url: 'https://www.ecta.com/wp-content/uploads/2021/03/ECTA-CEFIC-GUIDELINE-FOR-MEASURING-AND-MANAGING-CO2-ISSUE-1.pdf',
              },
              {
                label: 'Our World in Data \u2014 Cars, planes, trains: where do CO\u2082 emissions from transport come from? (IEA 2018)',
                url: 'https://ourworldindata.org/co2-emissions-from-transport',
              },
              {
                label: 'Eurostat \u2014 Freight transport statistics \u2014 modal split',
                url: 'https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Freight_transport_statistics_-_modal_split',
              },
              {
                label: 'European Commission \u2014 Sustainable and Smart Mobility Strategy (2020)',
                url: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:52020DC0789',
              },
              {
                label: 'International Transport Forum \u2014 ITF Transport Outlook 2021',
                url: 'https://www.itf-oecd.org/itf-transport-outlook-2021',
              },
            ].map(({ label, url }) => (
