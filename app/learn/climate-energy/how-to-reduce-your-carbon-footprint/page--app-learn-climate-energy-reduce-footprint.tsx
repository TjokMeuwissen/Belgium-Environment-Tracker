          ...
          <SectionCard id="calculator">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
              <div>
                ...
                {transport === 'no_car' && (
                  <p style={{ fontSize: '0.72rem', color: '#6b7280', background: '#f9fafb', borderRadius: 6, padding: '7px 10px', marginTop: -10, marginBottom: 18 }}>
                    The remaining ~1.2 t reflects public transport, shared mobility and your per-capita share of transport infrastructure — emissions that persist even without a private car.
                  </p>
                )}
              </div>
              <div>
