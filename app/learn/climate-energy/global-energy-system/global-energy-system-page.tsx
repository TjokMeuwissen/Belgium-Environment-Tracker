  ...
  return (
    <div style={{ background: '#f9fafb', borderRadius: 10, padding: '20px', marginBottom: 16 }}>
      ...
      <div style={{ fontSize: '0.78rem', color: '#9ca3af', marginBottom: 20 }}>
        ...
        The step efficiencies shown are assumed values consistent with current engineering practice — real-world figures vary by technology generation, scale, operating conditions and system design. The overall conclusion (~30% round-trip) is robust to reasonable variation in individual steps, but the exact final figure will differ by application.
      </div>
