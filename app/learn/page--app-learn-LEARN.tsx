...
const TOPICS = [
  {
    ...
    tiles: [
      ...
      { slug: 'global-energy-system',               title: 'Our Global Energy System',              image: '/images/learn/energy-system.jpg' },
    ],
  },
  {
  ...
  },
  {
    ...
    color: '#06b6d4',
    tiles: [
      { slug: 'what-is-a-circular-economy',       title: 'What is a Circular Economy?',          image: '/images/learn/circular-economy.PNG'  },
      { slug: 'belgiums-waste-system-explained',  title: "Belgium's Waste System Explained",      image: '/images/learn/blue-bag.PNG'          },
      { slug: 'plastic-the-recycling-reality',    title: 'Plastic: The Recycling Reality',        image: '/images/learn/plastic-recycling.jpg' },
      { slug: 'critical-raw-materials',            title: 'Critical Raw Materials',                image: '/images/learn/raw-material.jpg'      },
      { slug: 'plastic-pollution',                  title: 'Plastic Pollution',                     image: '/images/learn/plastic-pollution.jpg'  },
    ],
  },
  {
    id: 'water-soil',
  ...
  },
  {
    ...
    color: '#ec4899',
    tiles: [
      { slug: 'how-clean-is-your-car',      title: 'How Clean is Your Car?',                     image: '/images/learn/car-type.PNG'         },
      { slug: 'flying-the-high-altitude-footprint', title: 'Flying: the High-Altitude Footprint', image: '/images/learn/airplane.PNG'         },
      { slug: 'freight-moving-goods',       title: 'Freight: Moving Goods Around the World',      image: '/images/learn/container.jpg'        },
      { slug: 'urban-mobility',             title: 'Urban Mobility: Getting Out of the Car',      image: '/images/learn/urban-mobility.jpg'   },
    ],
  },
];
...
export default function LearnPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px 36px', paddingLeft: 'calc(24px + 200px + 28px)' }}>
