...
function EUSealingChart() {
  ...
  return (
    <div style={{ background: '#f9fafb', borderRadius: 10, padding: '20px', marginBottom: 16 }}>
      ...
      </p>      <ResponsiveContainer width="100%" height={280}>
      ...
      <p style={{ fontSize: '0.72rem', color: '#9ca3af', marginTop: 10, lineHeight: 1.5 }}>
        &#x26A0;&#xFE0F; Note: country-level sealing percentages are approximate. Figures are derived from Copernicus remote sensing data and national land-use statistics using slightly different methodologies across countries, making direct numerical comparisons indicative rather than precise. The relative ordering is robust; the exact percentages should be treated with caution.
      </p>
    </div>
  );
}
