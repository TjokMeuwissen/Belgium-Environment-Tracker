      ...
      <div className="detail-body">
        ...
        <div className="detail-main">
          ...
          <SectionCard id="sources">
            ...
            <Para>
              The sources of N and P in Belgian waterways are multiple and differ between the two nutrients. Agriculture is by far the dominant source of nitrogen; the picture for phosphorus is more mixed, with wastewater and urban sources playing a greater relative role.
            </Para>

            {/* Qualitative source breakdown */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
              <div>
                <div style={{ fontWeight: 700, fontSize: '0.85rem', color: '#374151', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ width: 12, height: 12, borderRadius: '50%', background: '#3b82f6', display: 'inline-block' }} />
                  Nitrogen — main sources
                </div>
                {[
                  { label: 'Agriculture', level: 'Dominant', color: '#dc2626', bg: '#fef2f2', text: 'Manure, slurry and synthetic fertiliser applied in excess of crop uptake — Belgium\'s intensive livestock sector makes this the overwhelming source in most catchments' },
                  { label: 'Atmospheric deposition', level: 'Significant', color: '#f97316', bg: '#fff7ed', text: 'Ammonia emitted from livestock farming is redeposited downwind onto soils and water surfaces — a major pathway for sensitive natural habitats far from fields' },
                  { label: 'Wastewater & septic tanks', level: 'Moderate', color: '#ca8a04', bg: '#fffbeb', text: 'Treated and untreated sewage contributes nitrogen particularly in densely populated or poorly connected rural areas' },
                  { label: 'Urban runoff', level: 'Minor', color: '#6b7280', bg: '#f9fafb', text: 'Stormwater runoff from roads, gardens and urban surfaces carries dissolved nitrogen to drainage systems' },
                ].map(s => (
                  <div key={s.label} style={{ background: s.bg, borderLeft: `3px solid ${s.color}`, borderRadius: '0 8px 8px 0', padding: '8px 12px', marginBottom: 8 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
                      <span style={{ fontWeight: 700, fontSize: '0.83rem', color: '#1a1a1a' }}>{s.label}</span>
                      <span style={{ fontSize: '0.72rem', fontWeight: 700, color: s.color }}>{s.level}</span>
                    </div>
                    <span style={{ fontSize: '0.8rem', color: '#374151', lineHeight: 1.55 }}>{s.text}</span>
                  </div>
                ))}
              </div>
              <div>
                <div style={{ fontWeight: 700, fontSize: '0.85rem', color: '#374151', marginBottom: 8, display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  Phosphorus — main sources
                </div>
                {[
                  { label: 'Agriculture', level: 'Dominant', color: '#dc2626', bg: '#fef2f2', text: 'Soil erosion and surface runoff carry phosphorus attached to fine soil particles — intensive tillage and bare winter soils are key risk factors' },
                  { label: 'Wastewater treatment', level: 'Significant', color: '#f97316', bg: '#fff7ed', text: 'Many smaller Belgian WWTPs lack tertiary phosphorus removal — even treated effluent contains phosphorus unless a dedicated removal step is applied' },
                  { label: 'Septic tanks & sewer overflows', level: 'Significant', color: '#ca8a04', bg: '#fffbeb', text: 'Untreated sewage from dispersed rural housing and combined sewer overflow events deliver concentrated phosphorus pulses to watercourses' },
                  { label: 'Legacy sediment release', level: 'Growing', color: '#8b5cf6', bg: '#f5f3ff', text: 'Phosphorus accumulated in river and lake sediments over decades is released back into the water column when sediments become oxygen-depleted — an internal source that persists even after external inputs are reduced' },
                ].map(s => (
                  <div key={s.label} style={{ background: s.bg, borderLeft: `3px solid ${s.color}`, borderRadius: '0 8px 8px 0', padding: '8px 12px', marginBottom: 8 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
                      <span style={{ fontWeight: 700, fontSize: '0.83rem', color: '#1a1a1a' }}>{s.label}</span>
          ...
          <SectionCard id="solutions">
            ...
            <InfoCard emoji="&#x1F33F;" title="Buffer strips — the field-to-river barrier" color="#15803d" bg="#f0fdf4">
              ...
              <p style={{ margin: 0 }}>
                In Belgium, buffer strips of at least 1 metre are legally required along most watercourses, with wider strips (3&#x2013;9 m depending on water body classification) along more sensitive rivers and under agri-environment schemes. Compliance is monitored by satellite imagery analysis. Wider strips with diverse vegetation are significantly more effective than narrow grass strips — research consistently shows that well-maintained buffer strips of sufficient width can significantly reduce nitrate concentrations in shallow groundwater before it reaches the river, though effectiveness varies considerably with strip width, soil type and local hydrology.
              </p>
            </InfoCard>
