...
function HouseExplorer() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      {/* SVG house — centred, capped at 400px so it doesn't stretch too wide */}
      ...
      <div style={{ width: '100%', background: '#fff', borderRadius: 12, border: '1px solid #f3f4f6', padding: '16px 18px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
        {!room ? (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 80, fontSize: '0.88rem', color: '#9ca3af', textAlign: 'center', lineHeight: 1.7 }}>
