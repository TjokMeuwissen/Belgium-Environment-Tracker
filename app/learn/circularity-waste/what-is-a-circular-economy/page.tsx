      ...
      <div className="detail-body">
        ...
        <div className="detail-main">
          ...
          <SectionCard id="lansink">
            ...
            {/* Lansink image — full width, no cropping, native aspect ratio 723×393 */}
            <div style={{ margin: '20px 0', borderRadius: 8, overflow: 'hidden', border: '1px solid #e5e7eb' }}>
              <Image
                src="/images/learn/Lansink-ENG.jpg"
                alt="Ladder of Lansink: Reduce, Reuse, Recycle, Energy, Incineration, Landfill"
                width={723}
                height={393}
