      ...
      <ResponsiveContainer width="100%" height={280}>
        ...
        >
          ...
          <XAxis
            ...
            tickFormatter={v => `${v}`}
            label={{ value: 'g CO\u2082e per passenger-km', position: 'insideBottom', offset: -2, style: { fontSize: 10, fill: '#6b7280' } }}
          />
          <YAxis type="category" dataKey="name" tick={{ fontSize: 11, fill: '#374151' }} width={158} />
        ...
        <div className="detail-main">
          ...
          <SectionCard id="shorthaul">
            ...
            <div style={{
              ...
              {[
                { route: 'Brussels \u2013 Paris', train: '1h 22m', plane: '3h 30m*', winner: 'train' },
                { route: 'Brussels \u2013 London', train: '1h 51m', plane: '3h 45m*', winner: 'train' },
                { route: 'Brussels \u2013 Amsterdam', train: '1h 49m', plane: '3h 15m*', winner: 'train' },
                { route: 'Brussels \u2013 Cologne', train: '1h 48m', plane: '3h 00m*', winner: 'train' },
              ].map(r => (
                <div key={r.route} style={{
                  background: '#f0fdf4', border: '1px solid #bbf7d0',
                  borderRadius: 8, padding: '12px 14px',
                }}>
                  <p style={{ fontFamily: 'Roboto, sans-serif', fontWeight: 700, fontSize: '0.85rem', color: '#1a1a1a', marginBottom: 6 }}>{r.route}</p>
                  <p style={{ fontFamily: 'Roboto, sans-serif', fontSize: '0.8rem', color: '#374151', marginBottom: 2 }}>
                    &#x1F686; Train: <strong>{r.train}</strong>
                  </p>
                  <p style={{ fontFamily: 'Roboto, sans-serif', fontSize: '0.8rem', color: '#374151' }}>
                    &#x2708;&#xFE0F; Plane: <strong>{r.plane}</strong>
                  </p>
                </div>
              ))}
            </div>
            <p style={{ fontSize: '0.72rem', color: '#6b7280', fontFamily: 'Roboto, sans-serif', marginBottom: 16, lineHeight: 1.4 }}>
              * Plane times are door-to-door estimates including 90 min check-in, security, and airport transit at both ends.
              Train times are city-centre to city-centre (Thalys / Eurostar timetable 2025).
            </p>
          </SectionCard>
          ...
          <SectionCard id="sources">
            ...
            {[
              {
                label: 'Our World in Data \u2014 Which form of transport has the smallest carbon footprint? (Hannah Ritchie, 2023)',
                url: 'https://ourworldindata.org/travel-carbon-footprint',
              },
              {
                label: 'UK Government DESNZ \u2014 Greenhouse Gas Reporting: Conversion Factors 2022',
                url: 'https://www.gov.uk/government/publications/greenhouse-gas-reporting-conversion-factors-2022',
              },
              {
                label: 'Lee et al. (2020) \u2014 The contribution of global aviation to anthropogenic climate forcing for 2000 to 2018. Atmospheric Environment.',
                url: 'https://doi.org/10.1016/j.atmosenv.2020.117834',
              },
              {
                label: 'ICCT \u2014 CO\u2082 Emissions from Commercial Aviation (2018)',
                url: 'https://theicct.org/sites/default/files/publications/ICCT_CO2-commercl-aviation-2018_20190918.pdf',
              },
              {
                label: 'Back on Track \u2014 New comparison from EEA on trains versus planes',
                url: 'https://back-on-track.eu/new-comparison-from-european-environmental-agency-eea-on-trains-versus-planes/',
              },
              {
                label: 'Brussels Airport \u2014 Traffic statistics 2023',
                url: 'https://www.brusselsairport.be/en/our-airport/brussels-airport-company/press/traffic-statistics',
              },
            ].map(({ label, url }) => (
              <div key={url} style={{ borderLeft: '3px solid #e5e7eb', paddingLeft: 14, marginBottom: 12 }}>
                <a
                  href={url}
                  target="_blank"
