...
const TOPICS = [
  {
    ...
    tiles: [
      ...
      { slug: 'carbon-footprint',                  title: 'Carbon Footprint'                      },
      { slug: 'how-to-reduce-your-carbon-footprint', title: 'How to Reduce Your Carbon Footprint' },
      { slug: 'renewables-the-basics',             title: 'Renewables: The Basics'                },
    ],
  },
  {
    ...
    color: '#22c55e',
    tiles: [
      { slug: 'what-is-biodiversity',              title: 'What is Biodiversity?'                 },
      { slug: 'why-are-species-disappearing',      title: 'Why Are Species Disappearing?'         },
      { slug: 'protected-areas-explained',         title: 'Protected Areas Explained'             },
      { slug: 'invasive-species-in-belgium',       title: 'Invasive Species in Belgium'           },
      { slug: 'how-farming-shapes-nature',         title: 'How Farming Shapes Nature'             },
    ],
  },
  {
          ...
          {TOPICS.map(topic => (
            <section key={topic.id} id={topic.id}>
              ...
              <div style={{ background: '#1a1a1a', borderRadius: 10, padding: '14px 20px', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ width: 4, height: 22, background: topic.color, borderRadius: 2, flexShrink: 0 }} />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16 }}>
                {topic.tiles.map(tile => (
                  ...
                  >
                    ...
                    <span style={{ fontFamily: 'Epilogue, sans-serif', fontSize: '0.8rem', fontWeight: 700, color: topic.color, marginTop: 'auto' }}>
                      Read →
                    </span>
                  </Link>
                ))}
