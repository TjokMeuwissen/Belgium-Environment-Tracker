...
const TILES: Record<string, Record<string, { title: string; image?: string }>> = {
  ...
  'nature-biodiversity': {
    'what-is-biodiversity':               { title: 'What is Biodiversity?'               },
    'why-are-species-disappearing':       { title: 'Why Are Species Disappearing?'       },
    'protected-areas-explained':          { title: 'Protected Areas Explained'           },
    'invasive-species-in-belgium':        { title: 'Invasive Species in Belgium'         },
    'how-farming-shapes-nature':          { title: 'How Farming Shapes Nature'           },
  },
  'circularity-waste': {
    'what-is-a-circular-economy':         { title: 'What is a Circular Economy?'        },
    'belgiums-waste-system-explained':    { title: "Belgium's Waste System Explained"   },
    'plastic-the-recycling-reality':      { title: 'Plastic: The Recycling Reality'     },
    'from-linear-to-circular':            { title: 'From Linear to Circular: How It Works' },
  },
  'water-soil': {
