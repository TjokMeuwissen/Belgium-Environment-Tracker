...
const COUNTRY_MARKERS: CountryMarker[] = [
  { name: 'Qatar',        dayOfYear: 35,  earths: 10.0, row: 2 },
  { name: 'Luxembourg',   dayOfYear: 48,  earths: 7.7,  row: 1 },
  { name: 'Denmark',      dayOfYear: 79,  earths: 4.7,  row: 3 },
  { name: 'Austria',      dayOfYear: 92,  earths: 4.0,  row: 2 },
  { name: 'Belgium',      dayOfYear: 101, earths: 3.6,  row: 1, highlight: true },
  { name: 'France',       dayOfYear: 114, earths: 3.2,  row: 3 },
  { name: 'Germany',      dayOfYear: 130, earths: 2.8,  row: 2 },
  { name: 'UK',           dayOfYear: 142, earths: 2.6,  row: 1 },
  { name: 'China',        dayOfYear: 147, earths: 2.5,  row: 3 },
  { name: 'Argentina',    dayOfYear: 164, earths: 2.2,  row: 2 },
  { name: 'South Africa', dayOfYear: 185, earths: 2.0,  row: 1 },
  { name: 'Brazil',       dayOfYear: 226, earths: 1.6,  row: 3 },
  { name: 'Ghana',        dayOfYear: 268, earths: 1.4,  row: 2 },
  { name: 'Colombia',     dayOfYear: 274, earths: 1.3,  row: 3 },
  { name: 'Honduras',     dayOfYear: 331, earths: 1.1,  row: 1 },
];
...
const YEAR_MARKERS: YearMarker[] = [
  ...
  { year: '2020', dayOfYear: 235, row: 1, note: 'COVID' },
  { year: '2000', dayOfYear: 267, row: 2 },
  { year: '1995', dayOfYear: 278, row: 3 },
  { year: '1990', dayOfYear: 284, row: 1 },
  { year: '1982', dayOfYear: 319, row: 2 },
  { year: '1972', dayOfYear: 344, row: 3 },
];
...
function ComparisonTable() {
  ...
  return (
    <div style={{ overflowX: 'auto' as const }}>
        ...
        <tbody>
          ...
          {COMPARISON_LOW.map(r => (
            <tr key={r.country} style={{ background: '#fff' }}>
              <td style={{ ...cellStyle(true), textAlign: 'left' as const }}>{r.country}</td>
              <td style={cellStyle()}>#{r.epiRank}</td>
              <td style={cellStyle()}>
      ...
      <p style={{
        fontFamily: 'Roboto, sans-serif', fontSize: '0.75rem', color: '#4b5563',
        marginTop: 8, lineHeight: 1.5,
      }}>
        Sources: Yale EPI 2024; Global Footprint Network, Country Overshoot Days 2026.
      </p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 20 }}>
        ...
        <span style={{
          fontFamily: 'Roboto, sans-serif', fontSize: '0.82rem', color: '#4b5563',
          marginLeft: 4,
        }}>
        ...
        <div style={{ position: 'relative' as const, height: 8, borderRadius: 4, background: '#e5e7eb' }}>
          ...
          {MONTH_LABELS.map(m => (
            <div key={m.label} style={{
              ...
              transform: 'translateX(-50%)',
              fontFamily: 'Roboto, sans-serif',
              fontSize: '0.65rem', color: '#6b7280', whiteSpace: 'nowrap' as const,
            }}>
              {m.label}
            </div>
          ))}
...
function EPIIndicatorChart() {
            ...
            <div style={{ position: 'relative' as const, flexShrink: 0 }}>
              <button
                ...
                style={{
                  ...
                  color: '#6b7280', fontSize: '0.75rem', padding: '0 2px',
  ...
  return (
    <div>
      ...
      <p style={{
        fontFamily: 'Roboto, sans-serif', fontSize: '0.72rem', color: '#4b5563',
        marginTop: 12, lineHeight: 1.5,
      }}>
        Source: Yale EPI 2024 (epi.yale.edu).
      </p>
    </div>
  );
}
      ...
      >
        <div className="detail-header-inner">
          <div style={{ flex: 1 }}>
            ...
            <p className="header-eyebrow" style={{ marginTop: 16, color: '#aaa' }}>
              April 2026
            </p>
            ...
            <p style={{
              color: '#d1d5db', fontSize: '0.92rem', marginTop: 14,
