...
const POSTS: BlogPost[] = [
  {
    slug: 'epi-vs-overshoot',
    title: 'Environmental leader, ecological debtor: the paradox of Belgium\'s green scores',
    intro:
      'Belgium ranks 15th globally on environmental performance and needs 3.6 planets to sustain its lifestyle. These two facts are not a contradiction \u2014 they are a warning.',
    topics: ['Climate', 'Biodiversity'],
    date: 'April 2026',
    image: '/images/blog/epi-overshoot.jpg',
  },
  {
