        ...
        <div className="detail-main">
          ...
          <div className="detail-info">
            ...
            <div id="technical-info">
              ...
              {!['protected-land-area-terrestrial','organic-farming-share','farmland-bird-population-index','invasive-alien-species-threatening-red-listed-species'].includes(slug) && ind?.notes && <TechnicalInfoCard text={ind.notes} />}
            </div>
