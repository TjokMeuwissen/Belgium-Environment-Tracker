...
const SLUG_MAP: Record<string, string> = {
  ...
  'farmland-bird-population-index':                        'Pollinator decline reversal (farmland bird index proxy)',
    ...
    <div className="detail-chart-block">
      ...
      <ResponsiveContainer width="100%" height={640}>
        <BarChart data={EU_COMPARISON} layout="vertical" margin={{ top: 4, right: 48, left: 100, bottom: 4 }}>
          ...
          <YAxis type="category" dataKey="country" width={96} tick={<BoldTick />} tickLine={false} axisLine={false} />
          <Tooltip contentStyle={TOOLTIP_STYLE} formatter={(v: any, n: any, p: any) => [`${v}%`, p.payload.country]} cursor={{ fill: 'rgba(0,0,0,0.04)' }} />
      ...
      <div style={{ display: 'flex', gap: 16, marginTop: 10, flexWrap: 'wrap' }}>
        {[['#bbf7d0', '✅ Achieved (≥30%)'], ['#fef08a', '🟡 Close (20–30%)'], ['#fecaca', '🔴 Off track (<20%)'], ['#b91c1c', '🇧🇪 Belgium']].map(([color, label]) => (
