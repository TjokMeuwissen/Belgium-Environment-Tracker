        ...
        <div className="detail-main">
          ...
          <div className="detail-info">
            ...
            <div id="technical-info">
              ...
              {!['protected-land-area-terrestrial','organic-farming-share','farmland-bird-population-index','invasive-alien-species-threatening-red-listed-species','species-habitats-in-favourable-conservation-status'].includes(slug) && ind?.notes && <TechnicalInfoCard text={ind.notes} />}
            </div>
